...
<?php $__env->startSection('Title', 'Become A Driver - Clear Way Custom Clearance'); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <img class="float-right" src="<?php echo e(asset('img/pics/img25.jpg')); ?>" width="360" alt="" />
                ...
                <div class="col-md-12">
                    <div class="carousel-container">
                        <div id="client-carousel" class="owl-carousel owl-carousel-navigation">
                            ...
                            <div class="owl-item"><img src="<?php echo e(asset('img/pics/client03.png')); ?>" alt="" /></div>
                            <div class="owl-item"><img src="<?php echo e(asset('img/pics/client04.png')); ?>" alt="" /></div>
                            <div class="owl-item"><img src="<?php echo e(asset('img/pics/client05.png')); ?>" alt="" /></div>
                            <div class="owl-item"><img src="<?php echo e(asset('img/pics/client06.png')); ?>" alt="" /></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\CustomClearance\resources\views/become-driver.blade.php ENDPATH**/ ?>