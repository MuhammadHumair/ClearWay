...
<?php $__env->startSection('Title', 'Consulting Services - Custom Clearance Services'); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-5">
                            <img src="<?php echo e(asset('img/pics/img40.jpg')); ?>" alt="" />
                        </div><!-- .col-md-4 end -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\CustomClearance\resources\views/consulting-services.blade.php ENDPATH**/ ?>