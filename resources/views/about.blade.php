...
@section('Title', 'About - Clear Way Custom Clearance')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <ul class="fa-ul">
                        ...
                        <li>
                            <i class="fa fa-li fa-long-arrow-right"></i>
                            Investing in technology to provide fast, acurate and cost-effective
                            service
                        </li>
                ...
                <div class="col-md-12">
                    <div class="carousel-container">
                        <div id="client-carousel" class="owl-carousel owl-carousel-navigation">
                            <div class="owl-item">
                                <img src="{{ asset('img/pics/client01.png') }}" alt="" />
                            </div>
                            <div class="owl-item">
                                <img src="{{ asset('img/pics/client02.png') }}" alt="" />
                            </div>
                            <div class="owl-item">
                                <img src="{{ asset('img/pics/client03.png') }}" alt="" />
                            </div>
                            <div class="owl-item">
                                <img src="{{ asset('img/pics/client04.png') }}" alt="" />
                            </div>
                            <div class="owl-item">
                                <img src="{{ asset('img/pics/client05.png') }}" alt="" />
                            </div>
                            <div class="owl-item">
                                <img src="{{ asset('img/pics/client06.png') }}" alt="" />
                            </div>
                        </div>
