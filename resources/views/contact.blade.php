...
@section('Title', 'Contact Us - Clear Way Custom Clearance')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <!-- .contact form start -->
                    <form action="{{ route('contact.form.submit') }}" method="POST" class="wpcf7 clearfix">
                        @csrf
                        <fieldset>
                        ...
                        <fieldset>
                            ...
                            <textarea rows="8" class="wpcf7-textarea" name="message" id="message">{{ old('message') }}</textarea>
                        </fieldset>
                ...
                <div class="col-md-6">
                    ...
                    <strong>
                        <a href="{{ url('mailto:sales@clearwaysa.com') }}">sales@clearwaysa.com</a>
                    </strong>
                </div><!-- .col-md-6 end -->
            </div><!-- .row end -->
        </div><!-- .container end -->
