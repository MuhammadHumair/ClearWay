...
@section('Title', 'Home - Clear Way Custom Clearance')
    ...
    <div class="master-wrapper">
        ...
        <div id="masterslider" class="master-slider ms-skin-default mb-0">
            ...
            <div class="ms-slide" data-delay="5">
                <img src="{{ asset('masterslider/blank.gif') }}" data-src="{{ asset('img/slider/slide05-05.jpg') }}"
                    alt="" />
                ...
                <img class="ms-layer" src="{{ asset('masterslider/blank.gif') }}"
                    data-src="{{ asset('img/slider/slide05-04.png') }}" alt="" style="left: 350px; top: 160px;"
                    data-type="image" data-delay="1300" data-effect="right(short)" />

                <img class="ms-layer" src="{{ asset('masterslider/blank.gif') }}"
                    data-src="{{ asset('img/slider/slide05-03.png') }}" alt="" style="left: 770px; top: 85px;"
            ...
            <!-- slide start -->
            <div class="ms-slide" data-delay="5">
                <img src="{{ asset('masterslider/blank.gif') }}" data-src="{{ asset('img/slider/slide05-01.jpg') }}"
                    alt="" />
                ...
                <img class="ms-layer" src="{{ asset('masterslider/blank.gif') }}"
                    data-src="{{ asset('img/slider/slide05-02.png') }}" alt="" style="left: 0px; top: 10px;"
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="service-feature-box">
                        <div class="service-media">
                            ...
                            <a href="{{ route('overland-transportation') }}" class="read-more02">
                                <span>
                                    Read more
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="service-feature-box">
                        <div class="service-media">
                            ...
                            <a href="{{ route('ocean-freight') }}" class="read-more02">
                                <span>
                                    Read more
                                    <i class="fa fa-chevron-right"></i>
                                </span>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="service-feature-box">
                        <div class="service-media">
                            ...
                            <a href="{{ route('air-freight') }}" class="read-more02">
                                <span>
                                    Read more
                                    <i class="fa fa-chevron-right"></i>
                                </span>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="service-feature-box">
                        <div class="service-media">
                            ...
                            <a href="{{ route('contract-logistics') }}" class="read-more02">
                                <span>
                                    Read more
                                    <i class="fa fa-chevron-right"></i>
                                </span>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="service-feature-box">
                        <div class="service-media">
                            ...
                            <a href="{{ route('ware-housing') }}" class="read-more02">
                                <span>
                                    Read more
                                    <i class="fa fa-chevron-right"></i>
                                </span>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="service-feature-box">
                        <div class="service-media">
                            ...
                            <a href="{{ route('consulting-services') }}" class="read-more02">
                                <span>
                                    Read more
                                    <i class="fa fa-chevron-right"></i>
                                </span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 clearfix">
                    ...
                    <a href="{{ route('about') }}" class="read-more">
                        <span>
                            Read more
                            <i class="fa fa-chevron-right"></i>
                        </span>
                ...
                <div class="col-md-6">
                    ...
                    <ul class="clients-li clearfix">
                        <li><img src="{{ asset('img/pics/client01.png') }}" alt="" /></li>
                        <li><img src="{{ asset('img/pics/client02.png') }}" alt="" /></li>
                        <li><img src="{{ asset('img/pics/client03.png') }}" alt="" /></li>
                        <li><img src="{{ asset('img/pics/client04.png') }}" alt="" /></li>
                        <li><img src="{{ asset('img/pics/client05.png') }}" alt="" /></li>
                        <li><img src="{{ asset('img/pics/client06.png') }}" alt="" /></li>
                    </ul><!-- .clients-li end -->
                </div><!-- .col-md-6 end -->
            </div><!-- .row end -->
        </div><!-- .container end -->
                ...
                <div class="col-md-12">
                    <div class="carousel-container">
                        <div id="client-carousel" class="owl-carousel owl-carousel-navigation">
                            <div class="owl-item"><img src="{{ asset('img/pics/client01.png') }}" alt="" />
                            </div>
                            <div class="owl-item"><img src="{{ asset('img/pics/client02.png') }}" alt="" />
                            </div>
                            <div class="owl-item"><img src="{{ asset('img/pics/client03.png') }}" alt="" />
                            </div>
                            <div class="owl-item"><img src="{{ asset('img/pics/client04.png') }}" alt="" />
                            </div>
                            <div class="owl-item"><img src="{{ asset('img/pics/client05.png') }}" alt="" />
                            </div>
                            <div class="owl-item"><img src="{{ asset('img/pics/client06.png') }}" alt="" />
                            </div>
